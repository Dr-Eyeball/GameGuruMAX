...
-- DESCRIPTION: [AFFECTED_VALUE=100(0,100)]
...
function object_collider_properties(e,terrain_distance, collision_force, detection_type, detection_trigger, force_bounce, user_global_affected, affected_value, value_process)
