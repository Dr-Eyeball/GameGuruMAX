...
local compass_posx		= 0.0
local compass_posy		= 0.0
local have_compass 		= 0
local compass_active 	= 0
local status  			= ""
local tEnt				= {}
local hl_icon			= {}
local hl_imgwidth		= {}
...
function compass_properties(e, pickup_range, pickup_text, compass_type, compass_mode, position_x, position_y, radial_size, base_image, spin_image, top_image, prompt_display, item_highlight, highlight_icon_imagefile)
	...
	xcompass[e].base_image = base_image
	xcompass[e].spin_image = spin_image
	xcompass[e].top_image = top_image
